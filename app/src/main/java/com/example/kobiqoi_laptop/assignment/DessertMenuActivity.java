...
public class DessertMenuActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new DessertMenuActivity.RetrieveMenuTask().execute("http://homepage.cs.latrobe.edu.au/jamorran/menu.json");
...
// get the menu
                ...
                JSONArray arr = jsonObj.getJSONArray("dessert");
                sendarr = jsonObj.getJSONArray("dessert");
