...
public class OtherDrinksMenuActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_other_drinks_menu);
        new OtherDrinksMenuActivity.RetrieveMenuTask().execute("http://homepage.cs.latrobe.edu.au/jamorran/menu.json");
    ...
    public void onItemClick(AdapterView<?> l, View v, int position, long id) {
        ...
        try
        {
            sendarr = jsonObj.getJSONArray("otherdrinks");
...
// get the menu
                ...
                JSONArray arr = jsonObj.getJSONArray("otherdrinks");
                sendarr = jsonObj.getJSONArray("otherdrinks");
