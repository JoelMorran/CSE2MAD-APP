...
public class OtherFoodMenuActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> l, View v, int position, long id) {
        ...
        if(extras != null) {
            ...
            try {
                sendarr = jsonObj.getJSONArray("otherfood");
...
// get the menu
                ...
                JSONArray arr = jsonObj.getJSONArray("otherfood");
                sendarr = jsonObj.getJSONArray("otherfood");
