...
public class KidsMenuActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new KidsMenuActivity.RetrieveMenuTask().execute("http://homepage.cs.latrobe.edu.au/jamorran/menu.json");
    ...
    public void onItemClick(AdapterView<?> l, View v, int position, long id) {
        ...
        if(extras != null) {
            ...
            try {
                sendarr = jsonObj.getJSONArray("kids");
...
// get the menu
                ...
                JSONArray arr = jsonObj.getJSONArray("kids");
                sendarr = jsonObj.getJSONArray("kids");
