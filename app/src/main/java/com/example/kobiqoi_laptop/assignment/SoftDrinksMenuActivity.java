...
public class SoftDrinksMenuActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new SoftDrinksMenuActivity.RetrieveMenuTask().execute("http://homepage.cs.latrobe.edu.au/jamorran/menu.json");
    ...
    public void onItemClick(AdapterView<?> l, View v, int position, long id) {
        ...
        try
        {
            sendarr = jsonObj.getJSONArray("softdrinks");
...
// get the menu
                ...
                JSONArray arr = jsonObj.getJSONArray("softdrinks");
                sendarr = jsonObj.getJSONArray("softdrinks");
