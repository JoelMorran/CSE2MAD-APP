...
public class TeaCoffeeActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tea_coffee);
        new TeaCoffeeActivity.RetrieveMenuTask().execute("http://homepage.cs.latrobe.edu.au/jamorran/menu.json");
    ...
    public void onItemClick(AdapterView<?> l, View v, int position, long id) {
        ...
        if(extras != null) {
            ...
            try {
                sendarr = jsonObj.getJSONArray("teacoffee");
...
// get the menu
                ...
                JSONArray arr = jsonObj.getJSONArray("teacoffee");
                sendarr = jsonObj.getJSONArray("teacoffee");
